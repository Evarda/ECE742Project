...
% grid minor
% grid on
% title('Relative Error over Time for Varying Values of \sigma_{max}, m = 2, k_{max} = 3')
% xlabel('Time (s)');
...
% grid minor
% grid on
% title('Relative Error over Time for Varying Values of m, k = 1, \sigma_{max} = Optimal')
% xlabel('Time (s)');
% ylabel('Relative Error')
% axis([0, 2.1e-9, 1e-10, 10])
...
grid minor;
grid on;
title('Relative Error over Time for Varying Values of \sigma_{max}, m = 3, k_{max} = 1')
xlabel('Time (s)');
ylabel('Relative Error');
axis([0, 2.1e-9, 1e-10, 10])